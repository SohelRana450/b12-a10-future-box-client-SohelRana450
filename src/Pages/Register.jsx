       ...
       <div className="w-11/12 md:w-4/12 mx-auto my-14 card bg-base-300   shrink-0 shadow-2xl">
             <div className="card-body">
              ...
              <form onSubmit={handleRegister} >
               ...
               <p className='text-lg font-bold py-2 '>Already Have An Account. Please <Link to="/auth/login" className='text-pink-700 underline text-md font-bold'>Log In</Link>.</p>
                      {/* Google */}
