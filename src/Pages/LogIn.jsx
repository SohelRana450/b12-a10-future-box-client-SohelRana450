...
const LogIn = () => {
  ...
  const handleGoogleSign =()=>{
    ...
    <div className="mx-auto my-20 card bg-base-300 w-full max-w-md ">
      <div className="card-body">
        <h1 className="text-5xl text-center font-bold font-mono">Login now!</h1>
        ...
        <p>Create An Account? Please <Link to="/auth/register" className='text-blue-500 underline'>Register</Link>.</p>
        {/* Google */}
<button onClick={handleGoogleSign} className="btn bg-white text-black border-[#e5e5e5] font-bold text-md">
